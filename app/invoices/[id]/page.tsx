    ...
    const loadInvoice = async () => {
      ...
      try {
        ...
        const { data: invoiceRow, error: invoiceError } = await supabase
          .from("invoices")
          .select(
            "id, invoice_number, issued_on, due_date, paid, currency, notes, from_name, from_company, from_email, from_address_line1, from_address_line2, from_city, from_state, from_postal_code, from_country, to_name, to_company, to_email",
          )
          .eq("id", invoiceId)
          .single<InvoiceRow>();

        ...
        <div className="flex min-w-0 flex-col gap-6 no-print">
          ...
          >
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <label className="rounded-2xl border border-white/10 bg-slate-900/60 px-4 py-3 text-sm">
                <span className="text-xs text-slate-300">Invoice number</span>
                <input
                  className="mt-2 w-full bg-transparent text-white outline-none"
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              ...
              <label className="rounded-2xl border border-white/10 bg-slate-900/60 px-4 py-3 text-sm">
                ...
                <input
                  ...
                  onChange={(event) =>
                    updatePartyField("from", "addressLine1", event.target.value)
                  }
                />
              </label>
              <label className="rounded-2xl border border-white/10 bg-slate-900/60 px-4 py-3 text-sm">
                ...
                <input
                  ...
                  onChange={(event) =>
                    updatePartyField("from", "addressLine2", event.target.value)
                  }
                />
              </label>
              <label className="rounded-2xl border border-white/10 bg-slate-900/60 px-4 py-3 text-sm">
              ...
              <label className="rounded-2xl border border-white/10 bg-slate-900/60 px-4 py-3 text-sm">
                <span className="text-xs text-slate-300">From postal code</span>
                <input
                  className="mt-2 w-full bg-transparent text-white outline-none"
            ...
            <label className="mt-4 block rounded-2xl border border-white/10 bg-slate-900/60 px-4 py-3 text-sm">
              ...
              {invoice.lines.map((line) => (
                ...
                >
                  <div className="grid items-center gap-3 md:grid-cols-[minmax(0,1fr)_90px_110px_auto]">
                    <input
                      className="min-w-0 rounded-xl border border-white/10 bg-transparent px-3 py-2 text-sm text-white outline-none"

  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--ink)" }}>
      ...
      >
        ...
        <form onSubmit={handleEmailSignIn} className="card" style={{ padding: 28, width: "100%", display: "flex", flexDirection: "column", gap: 14 }}>
          <div style={fieldBox}>
          ...
          <div style={fieldBox}>
            ...
            <input style={fieldInput} type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" required />
          </div>
        ...
        <p style={{ fontSize: 12, color: "var(--text-muted)" }}>
          No account? <a href="/signup" style={{ color: "var(--gold)" }}>Sign up</a>
        </p>
      </div>
    </div>
  );
